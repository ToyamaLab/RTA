...
//                            }
                            if (stringBytes > maxStringColWidth) {
                                value = value.substring(0, maxStringColWidth - 3) + "...";
                            }
                            if (c.getLabel().equals("name")) {
//                            	System.out.println("stringBytes: " + stringBytes + ", cWidth: " + c.getWidth());
                            }
...
//                    c.setWidth(value.length() > c.getWidth() ? value.length() : c.getWidth());
                    c.setWidth(stringBytes > c.getWidth() ? stringBytes : c.getWidth());
                    c.addValue(value);
...
//            System.out.print(strToPrint.toString());
            System.out.print(transliterator.transliterate(strToPrint.toString()));
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
//                	
//                	int trueWidth = c.getWidth();
//                	char[] chars = c.getValue(i).toCharArray();
//                    for (char ch : chars) {
//                    	if ((ch <= '\u007e') || // 英数字
//								(ch == '\u00a5') || // \記号
//								(ch == '\u203e') || // ~記号
...
//                    format = String.format("| %%%s%ds ", c.getJustifyFlag(), trueWidth);
                    format = String.format("| %%%s%ds ", c.getJustifyFlag(), c.getWidth());
//                    System.out.print(String.format(format, c.getValue(i)));
                    System.out.print(transliterator.transliterate(String.format(format, c.getValue(i))));
                }

//                System.out.println("|");
//                System.out.print(rowSeparator);
                System.out.println(transliterator.transliterate("|"));
                System.out.print(transliterator.transliterate(rowSeparator.toString()));
            }
