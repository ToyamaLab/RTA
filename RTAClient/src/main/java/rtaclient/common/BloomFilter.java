...
public class BloomFilter<E> implements Serializable {
    ...
    public BloomFilter(BitSet bitset,int expectedNumberOElements,double falsePositiveProbability) {
        this.bitset = bitset;
        this.bitSetSize = (int)Math.ceil(Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2)*expectedNumberOElements);
